...
public class SelectCandidates implements ImageSelector {
	...
	public ArrayList<Image> select(ArrayList<Image> images) {
		...
		for(Image img : images) {
			...
			if(counter > (img.namesVol.size()/2)) {
				subSet.add(img);
			}
		}
