...
public class ExamPart1 {
	...
	public static void main(String[] args) throws IOException {
		...
		for(Recording record : records) {
			System.out.println("Filename: "+record.name);
			System.out.println("Duration of the recording: "+record.calcDuration()+"s");
			System.out.println("Amplitude of the signal in dBFS: "+record.calcAmp());
			System.out.println("Instrument used in making the recording: "+index.get(record.name));
		}
